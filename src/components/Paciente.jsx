        ...
        <div className="m-3 bg-white shadow-md px-5 py-10 rounded-xl">
            ...
            <div className="flex justify-between mt-10">
                <button type="button" className="py-2 px-10 bg-indigo-600 hover:bg-indigo-700 text-white 
                        ...
                        onClick={ () => setPaciente(paciente)} > {/* usamos collback porq espera hasta q se le haga click para cargar todo
                                                                si ponemos directamente set paciente setPaciente() ya carga al toke */}
                    Editar
                </button>
